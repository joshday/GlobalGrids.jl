...
@inline LatLng(o::AbstractCoordinates) = LatLng(LonLatAuthalic(o))
@inline LatLng(o::LonLatAuthalic) = LatLng(deg2rad.(o.pt.data)...)  # (lon, lat) in degrees
@inline LonLatAuthalic(o::LatLng) = LonLatAuthalic(Point(rad2deg(o.lng), rad2deg(o.lat)))  # (lon, lat) in degrees
...
macro libh3(ex)
    ...
    esc(quote
        @inline function $fun_name($(arg_names...))
